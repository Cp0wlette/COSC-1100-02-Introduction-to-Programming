# Filename: Pizza Pi Iteration - Assignment 1 - Christian Poweltte
# Date: 2023-10-20
# Christian Powlette
...
# CONSTANTS 
# stores the size of a 6 inch pizza
SIX_SLICES_SIZE = 6
# stores the size of a 8 inch pizza
EIGHT_SLICES_SIZE = 8
# stores the size of a 10 inch pizza
TEN_SLICES_SIZE = 10
# stores the size of a 12 inch pizza
TWELVE_SLICES_SIZE = 12
# stores the size of a 16 inch pizza
SIXTEEN_SLICES_SIZE = 16
...
sixteen_slices = 0
# list that stores the slices for each size
slices = [0]
# tuple that contains the size of each slice
slices_size = (0, 6, 8, 10, 12, 16)
...
while pizza_diameter != 0:
    ...
    if pizza_diameter >= 8 and pizza_diameter <= 24:
        ...
        if pizza_diameter >= 8 or pizza_diameter >= 24:
            #store the pizza area in a variable after diving it by 6 slices size
            six_slices = pizza_area / SIX_SLICES_SIZE
            # store the rounded number from the previous calculation
            six_slices =  round(six_slices, 2)
            # appends the calculated, and rounded number in a list with slices
            slices.append[six_slices]
        ...
        if pizza_diameter >= 12 or pizza_diameter >= 24:
            #store the pizza area in a variable after diving it by 8 slices size
            eight_slices = pizza_area / EIGHT_SLICES_SIZE
            # store the rounded number from the previous calculation
            eight_slices =  round(eight_slices, 2)
            # appends the calculated, and rounded number in a list with slices
            slices.append[eight_slices]
            #print the output message of pizza results with calculation and units.
        ...
        if pizza_diameter >= 14 or pizza_diameter >= 24:
            #store the pizza area in a variable after diving it by 10 slices size
            ten_slices = pizza_area / TEN_SLICES_SIZE
            # store the rounded number from the previous calculation
            ten_slices =  round(ten_slices, 2)
            # appends the calculated, and rounded number in a list with slices
            slices.append[ten_slices]
            #print the output message of pizza results with calculation and units.
        ...
        if pizza_diameter >= 16 or pizza_diameter >= 24:
            #store the pizza area in a variable after diving it by 12 slices size
            twelve_slices = pizza_area / TWELVE_SLICES_SIZE
            # store the rounded number from the previous calculation
            twelve_slices =  round(twelve_slices, 2)
            # appends the calculated, and rounded number in a list with slices
            slices.append[twelve_slices]
            #print the output message of pizza results with calculation and units.
        ...
        if pizza_diameter >= 20 or pizza_diameter >= 24:
            #store the pizza area in a variable after diving it by 16 slices size
            sixteen_slices = pizza_area / SIXTEEN_SLICES_SIZE
            # store the rounded number from the previous calculation
            sixteen_slices =  round(sixteen_slices, 2)
            # appends the calculated, and rounded number in a list with slices
            slices.append[sixteen_slices]
            #print the output message of pizza results with calculation and units.
            #print("The pizza cut into 16 slices results in " + str(sixteen_slices) + " inches per slice")
    #loops and prints the output for each slice size
    for i in slices:
        print("The pizza cut into ", slices_size[i], " slices results in " + str(slices[i]) + " inches per slice")
